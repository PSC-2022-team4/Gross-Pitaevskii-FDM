 ...
 * @param g_ 
 */
BaseSolver::BaseSolver(InitialCondition initialCondition_, std::function<double(double, double)> potential_func_, double g_, BaseDomain baseDomain_)
    : initialCondition(initialCondition_), potential_func(potential_func_), g(g_), domain(&baseDomain_){};
